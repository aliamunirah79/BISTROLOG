...
class _ManageRecipePageState extends State<ManageRecipePage> {
  ...
  Future<void> openAddRecipePage() async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => const AddEditRecipePage(),
      ),
    );
  ...
  Future<void> openEditRecipePage(Map<String, dynamic> recipe) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
  ...
  Future<void> deactivateRecipe(Map<String, dynamic> recipe) async {
    try {
      ...
      showMessage('Failed to delete recipe: $e', isError: true);
    }
  }

  void showDeleteDialog(Map<String, dynamic> recipe) {
    showDialog(
      context: context,
      builder: (dialogContext) {
        return AlertDialog(
          ...
          content: Text(
            'Are you sure you want to delete "${getRecipeName(recipe)}"?',
            style: TextStyle(
              ...
              PopupMenuButton<String>(
                ...
                itemBuilder: (context) => const [
                  PopupMenuItem(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.visibility, color: mulberry),
                        SizedBox(width: 8),
                        Text('View'),
                      ],
                    ),
                  ...
                  PopupMenuItem(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.edit, color: mulberry),
                        SizedBox(width: 8),
                        Text('Edit'),
                      ],
                    ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 5),
                Text(
                  'Add, update and delete cafe recipes.',
                  style: TextStyle(
                    color: creamDark,
