                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: Text(
                          isModalSaving ? 'Saving...' : 'Save Schedule',
                        ),
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton.icon(
                          onPressed: isModalSaving
                              ? null
                              : () async {
                                  final cancelled = await cancelSchedule(
                                    existingSchedule,
                                  );
...
Future<bool> cancelSchedule(Map<String, dynamic> schedule) async {
  final confirm = await showConfirmDialog(
...
Widget buildStaffScheduleRow(Map<String, dynamic> staff) {
  ...
  final role = normalizeRole(staff['role']);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      color:
                          role == 'supervisor' ? mulberry : Colors.grey.shade600,
                      fontSize: 10.5,
                      fontWeight: FontWeight.w600,
                    ),
                  ),
